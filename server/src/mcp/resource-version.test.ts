...
describe("reading nest resource version", () => {
  it("uses a fresh v53 URI while retaining earlier resources", () => {
  ...
  it("points every primary v53 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v53._meta;
