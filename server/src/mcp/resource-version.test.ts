...
describe("reading nest resource version", () => {
  it("uses a fresh v54 URI while retaining earlier resources", () => {
  ...
  it("points every primary v54 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v54._meta;
