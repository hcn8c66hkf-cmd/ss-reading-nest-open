...
describe("reading nest resource version", () => {
  it("uses a fresh v57 URI while retaining earlier resources", () => {
  ...
  it("points every primary v57 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v57._meta;
