...
describe("reading nest resource version", () => {
  it("uses a fresh v67 URI while retaining earlier resources", () => {
  ...
  it("points the primary v67 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v67._meta;
