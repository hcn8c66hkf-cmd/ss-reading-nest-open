...
describe("reading nest resource version", () => {
  it("uses a fresh v73 URI while retaining earlier resources", () => {
    expect(READING_NEST_URI).toBe("ui://ss-reading-nest/app-v73.html");
  ...
  it("points the primary v73 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v73._meta;
