...
describe("reading nest resource version", () => {
  it("uses a fresh v66 URI while retaining earlier resources", () => {
  ...
  it("points the primary v66 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v66._meta;
