...
describe("reading nest resource version", () => {
  it("uses a fresh v63 URI while retaining earlier resources", () => {
    expect(READING_NEST_URI).toBe("ui://ss-reading-nest/app-v63.html");
  ...
  it("points the primary v63 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v63._meta;
