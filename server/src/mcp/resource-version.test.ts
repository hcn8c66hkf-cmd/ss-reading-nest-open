...
describe("reading nest resource version", () => {
  it("uses a fresh v49 URI while retaining earlier resources", () => {
  ...
  it("points every primary v49 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v49._meta;
