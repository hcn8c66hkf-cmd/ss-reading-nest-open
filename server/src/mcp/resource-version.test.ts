...
describe("reading nest resource version", () => {
  it("uses a fresh v44 URI while retaining earlier resources", () => {
  ...
  it("points every primary v44 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v44._meta;
