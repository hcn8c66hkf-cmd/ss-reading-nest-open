...
describe("reading nest resource version", () => {
  it("uses a fresh v71 URI while retaining earlier resources", () => {
  ...
  it("points the primary v71 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v71._meta;
