...
describe("reading nest resource version", () => {
  it("uses a fresh v42 URI while retaining earlier resources", () => {
  ...
  it("points every primary v42 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v42._meta;
