...
describe("reading nest resource version", () => {
  it("uses a fresh v75 URI while retaining earlier resources", () => {
  ...
  it("points the primary v75 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v75._meta;
