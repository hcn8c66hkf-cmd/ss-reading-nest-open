...
describe("reading nest resource version", () => {
  it("uses a fresh v45 URI while retaining earlier resources", () => {
  ...
  it("points every primary v45 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v45._meta;
