...
describe("reading nest resource version", () => {
  it("uses a fresh v56 URI while retaining earlier resources", () => {
  ...
  it("points every primary v56 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v56._meta;
