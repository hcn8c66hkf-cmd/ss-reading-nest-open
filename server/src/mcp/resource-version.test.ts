...
describe("reading nest resource version", () => {
  it("uses a fresh v55 URI while retaining earlier resources", () => {
  ...
  it("points every primary v55 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v55._meta;
