...
describe("reading nest resource version", () => {
  it("uses a fresh v41 URI while retaining earlier resources", () => {
  ...
  it("points every primary v41 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v41._meta;
