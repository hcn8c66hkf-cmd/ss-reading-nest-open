...
describe("reading nest resource version", () => {
  it("uses a fresh v52 URI while retaining earlier resources", () => {
  ...
  it("points every primary v52 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v52._meta;
