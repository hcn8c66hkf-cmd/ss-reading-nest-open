...
describe("reading nest resource version", () => {
  it("uses a fresh v68 URI while retaining earlier resources", () => {
  ...
  it("points the primary v68 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v68._meta;
