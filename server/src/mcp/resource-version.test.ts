...
describe("reading nest resource version", () => {
  it("uses a fresh v65 URI while retaining earlier resources", () => {
  ...
  it("points the primary v65 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v65._meta;
