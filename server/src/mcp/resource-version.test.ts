...
describe("reading nest resource version", () => {
  it("uses a fresh v58 URI while retaining earlier resources", () => {
  ...
  it("points every primary v58 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v58._meta;
