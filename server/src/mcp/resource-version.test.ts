...
describe("reading nest resource version", () => {
  it("uses a fresh v60 URI while retaining earlier resources", () => {
  ...
  it("points every primary v60 resource hint at the fresh URI", () => {
    const meta = TOOL_CONFIGS.open_reading_nest_v60._meta;
