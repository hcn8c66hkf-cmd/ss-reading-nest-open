...
export const READING_NEST_URI = "ui://ss-reading-nest/app-v64.html";
export const READING_NEST_TOOL_NAME = "open_reading_nest_v64";
...
export function registerReadingTools(
  ...
  registerAppTool(
    ...
    TOOL_CONFIGS.open_reading_nest_v64,
    openReadingNest
  );
  registerAppTool(
    server,
