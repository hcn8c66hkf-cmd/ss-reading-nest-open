...
export const TOOL_CONFIGS = {
  open_reading_nest_v75: {
    title: "打开 S×S 小窝共读",
    description:
      "Use this primary v75 tool when the user wants to open the reading nest or continue recent reading. Each chapter gesture creates exactly one current-chat follow-up without replaying widget model context.",
  ...
  open_reading_nest_v67: {
    title: "打开 S×S 小窝共读",
    description:
      "Use this primary v67 tool when the user wants to open the reading nest or continue recent reading. Chapter taps and swipes wake the live-reading follow-up inside the originating user gesture; the durable server queue remains the source of truth.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
    _meta: {
      ui: { resourceUri: READING_NEST_URI },
  ...
  open_reading_nest_v66: {
    title: "打开 S×S 小窝共读",
    description:
      "Use this primary v66 tool when the user wants to open the reading nest or continue recent reading. Live chapters prefer the iOS compatibility follow-up so a new reply never replays the preceding assistant bubble.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
    _meta: {
      ui: { resourceUri: READING_NEST_URI },
  ...
  open_reading_nest_v65: {
    title: "打开 S×S 小窝共读",
    description:
      "Use this primary v65 tool when the user wants to open the reading nest or continue recent reading. Each chapter uses one host turn that claims context internally before replying.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
    _meta: {
      ui: { resourceUri: READING_NEST_URI },
  ...
  open_reading_nest_v64: {
    title: "打开 S×S 小窝共读",
    description:
      "Use this primary v64 tool when the user wants to open the reading nest or continue recent reading. Completed chapters are pruned from durable live-reading queues before delivery.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
    _meta: {
      ui: { resourceUri: READING_NEST_URI },
  ...
  open_reading_nest_v63: {
    title: "打开 S×S 小窝共读",
    description:
      "Use this primary v63 tool when the user wants to open the reading nest or continue recent reading. Live-reading claims never use the conversational compatibility tool bridge.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
    _meta: {
      ui: { resourceUri: READING_NEST_URI },
  ...
  open_reading_nest_v58: {
    title: "打开 S×S 小窝共读",
    description:
      "Use this primary v58 tool when the user wants to open the reading nest or continue recent reading. Novels use their original chapter structure with safe splitting only for exceptionally long chapters.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
    _meta: {
      ui: { resourceUri: READING_NEST_URI },
  ...
  open_reading_nest_v57: {
    title: "打开 S×S 小窝共读（v57 兼容入口）",
    description:
      "Legacy compatibility entry. Prefer open_reading_nest_v58 whenever it is available.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
    _meta: {
      ui: { resourceUri: READING_NEST_URI },
  ...
  open_reading_nest_v56: {
    title: "打开 S×S 小窝共读（v56 兼容入口）",
    description:
      "Legacy compatibility entry. Prefer open_reading_nest_v58 whenever it is available.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
  ...
  open_reading_nest_v55: {
    title: "打开 S×S 小窝共读（v55 兼容入口）",
    description:
      "Legacy compatibility entry. Prefer open_reading_nest_v58 whenever it is available.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
  ...
  open_reading_nest_v50: {
    title: "打开 S×S 小窝共读（v50 兼容入口）",
    description:
      "Legacy compatibility entry. Prefer open_reading_nest_v51 whenever it is available.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
    _meta: {
      ui: { resourceUri: READING_NEST_URI },
...
export function registerReadingTools(
  ...
  registerAppTool(
    server,
    "open_reading_nest_v66",
    TOOL_CONFIGS.open_reading_nest_v66,
    openReadingNest
  );
  registerAppTool(
    server,
  ...
  registerAppTool(
    server,
    "open_reading_nest_v57",
    TOOL_CONFIGS.open_reading_nest_v57,
    openReadingNest
  );
  registerAppTool(
    server,
    "open_reading_nest_v56",
    TOOL_CONFIGS.open_reading_nest_v56,
    openReadingNest
  );
  registerAppTool(
    server,
    "open_reading_nest_v55",
    TOOL_CONFIGS.open_reading_nest_v55,
    openReadingNest
  );
  registerAppTool(
    server,
  ...
  registerAppTool(
    server,
    "open_reading_nest_v50",
    TOOL_CONFIGS.open_reading_nest_v50,
    openReadingNest
  );
  registerAppTool(
    server,
  ...
  registerAppTool(
    server,
    "open_reading_nest_v43",
    TOOL_CONFIGS.open_reading_nest_v43,
    openReadingNest
  );
  registerAppTool(
    server,
