...
export const READING_NEST_URI = "ui://ss-reading-nest/app-v37.html";
...
export const TOOL_CONFIGS = {
  open_reading_nest_v37: {
    title: "打开 S×S 小窝共读",
    description:
      "Use this primary v37 tool when the user wants to open the reading nest or continue recent reading.",
  ...
  open_reading_nest_v36: {
    ...
    description:
      "Legacy compatibility entry. Prefer open_reading_nest_v37 whenever it is available.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
    _meta: {
      ui: { resourceUri: READING_NEST_URI },
