...
export const READING_NEST_URI = "ui://ss-reading-nest/app-v55.html";
export const READING_NEST_TOOL_NAME = "open_reading_nest_v55";
...
export const TOOL_CONFIGS = {
  open_reading_nest_v55: {
    title: "打开 S×S 小窝共读",
    description:
      "Use this primary v55 tool when the user wants to open the reading nest or continue recent reading. Novels use their original chapter structure with safe splitting only for exceptionally long chapters.",
  ...
  open_reading_nest_v52: {
    ...
    description:
      "Legacy compatibility entry. Prefer open_reading_nest_v55 whenever it is available.",
    inputSchema: openReadingNestInputSchema,
    annotations: readOnly,
    _meta: {
      ui: { resourceUri: READING_NEST_URI },
