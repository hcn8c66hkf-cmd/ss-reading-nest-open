...
export const READING_NEST_URI = "ui://ss-reading-nest/app-v36.html";
...
export const TOOL_CONFIGS = {
  open_reading_nest_v36: {
    title: "打开 S×S 小窝共读",
    description:
      "Use this primary v36 tool when the user wants to open the reading nest or continue recent reading.",
